...
int main() {
  ...
  cin >> n_students;
  cout << "Enter the number of postgraduate students: ";
  cin >> n_pgstudents;
  ...
  for (int i = 0; i < n_pgstudents; i++) {
    cout << "############### Registering Post Graduate Student " << i + 1
         << " ###############" << endl;
    fflush(stdin);
  ...
  cout << "############################### Post Graduate Student Information "
          "###############################"
       << endl;
  for (int i = 0; i < n_pgstudents; i++) {
